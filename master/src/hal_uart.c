...
#ifndef UART_NBUF
#define UART_NBUF   234
#endif

#define BAUD_115K2   1020  // = Round(1024 - (2*16e6)/(64*115200))	err: 7%
#define BAUD_57K6   1015  // = Round(1024 - (2*16e6)/(64*57600))	err: 3.6%
...
static uint8_t uart_tx[UART_NBUF];

static uint8_t uart_rx_wp, uart_rx_rp, uart_rx_cnt;
static uint8_t uart_rx[UART_NBUF];
